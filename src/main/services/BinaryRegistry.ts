...
export const DEFAULT_SERVICES: ServiceConfig[] = [
  ...
  { name: "mysql", label: "MySQL", kind: "database", port: 3306, enabled: true, binaryRelPath: "mysql/bin/mysqld.exe", args: [], configRelPath: "mysql/my.cnf", dataDirName: "mysql" },
  { name: "mariadb", label: "MariaDB", kind: "database", port: 3307, enabled: false, binaryRelPath: "mariadb/bin/mariadbd.exe", args: [], configRelPath: "mariadb/my.cnf", dataDirName: "mariadb" },
